...
from crear_csv_pow import compute_pow    #importo los resultados del archivo de carga
...
OUT_DIR    = Path(r"C:\Users\pprru\Desktop\salidas2")    

X, y, salida_x, salida_y, salida = compute_pow()
lista_user = devolver_nombre_usuarios(base_dir=BASE_DIR, demog_json=DEMOG_JSON, eda_csv=EDA_CSV)
